...
class Student(models.Model):
    ...
    sign = models.FileField(upload_to='media/',blank= True)
...
class Recommendation(models.Model):
    ...
    hodsign = models.FileField(upload_to='media/', blank= True)
    ...
    deansign = models.FileField(upload_to='media/',blank= True)
    ...
    dsasign = models.FileField(upload_to='media/',blank= True)
    pconsent = models.FileField(upload_to='media/',blank= True)
    ...
    unithead_sign = models.FileField(upload_to='media/', blank= True) 
    ...
    wspsign = models.FileField(upload_to='media/', blank= True)
