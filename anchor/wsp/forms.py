...
class RecommendationForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'deanrec' : forms.Textarea(attrs={'class': 'container', 'placeholder': "Dean's Recommendation", 'rows':3}),
            'deanname' : forms.TextInput(attrs={'class': 'container', 'placeholder': 'Full Name'}),
            'dsacom' : forms.Textarea(attrs={'class': 'container', 'placeholder': "DSA'S Recommendation", 'rows':3}),
            'dsaname' : forms.TextInput(attrs={'class': 'container', 'placeholder': 'Full Name'}),
            'unithead_comm': forms.Textarea(attrs={'class': 'container', 'placeholder': "Unit Head of Application's Comment", 'rows':3}),
            'unithead_name' : forms.TextInput(attrs={'class': 'container', 'placeholder': 'Full Name'}), 
            'wspcomm' : forms.Textarea(attrs={'class': 'container', 'placeholder': "WSP Chairman's Comment", 'rows':3}), 
